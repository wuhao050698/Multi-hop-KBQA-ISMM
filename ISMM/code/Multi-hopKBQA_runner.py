...
def main(args, load_save = None):
    ...
    train_r = read_golden_rel('/content/drive/MyDrive/5002/Multi-hopQA/data/mix-hop/MetaQA/%s/qa_train_qtype.txt' %folder)
    dev_r = read_golden_rel('/content/drive/MyDrive/5002/Multi-hopQA/data/mix-hop/MetaQA/%s/qa_dev_qtype.txt' %folder)
    test_r = read_golden_rel('/content/drive/MyDrive/5002/Multi-hopQA/data/mix-hop/MetaQA/%s/qa_test_qtype.txt' %folder)
...
if __name__ == '__main__':
    ...
    if args.task == 1: # x-hop PathQuestions
        main(args, load_save = '/content/drive/MyDrive/5002/Multi-hopQA/trained_model/PathQuestions')
    elif args.task == 2: # x-hop WC2014
        main(args, load_save = '/content/drive/MyDrive/5002/Multi-hopQA/trained_model/WC2014')
    elif args.task == 3: # x-hop MetaQA
        main(args, load_save = '/content/drive/MyDrive/5002/Multi-hopQA/trained_model/MetaQA_half')
    elif args.task == 0:
        main(args)
        # main(args, load_save = args.load_save)
