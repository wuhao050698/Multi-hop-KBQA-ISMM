...
def load_arguments():
    ...
    argparser.add_argument("--embedding",
            type = str,
            default = "/content/drive/MyDrive/5002/Multi-hopQA/code/glove.840B.300d.zip",
    ...
    argparser.add_argument("--train_q",
            type = str,
            default = "/content/drive/MyDrive/5002/Multi-hopQA/data/mix-hop/MetaQA/half/qa_train.txt",
            help = "path to training data"
        )
    argparser.add_argument("--dev_q",
            type = str,
            default = "/content/drive/MyDrive/5002/Multi-hopQA/data/mix-hop/MetaQA/half/qa_dev.txt",
            help = "path to development data"
        )
    argparser.add_argument("--test_q",
            type = str,
            default = "/content/drive/MyDrive/5002/Multi-hopQA/data/mix-hop/MetaQA/half/qa_test.txt",
            help = "path to test data"
        )
    argparser.add_argument("--kb_file",
            type = str,
            default = "/content/drive/MyDrive/5002/Multi-hopQA/data/mix-hop/MetaQA/half/kb_half.txt",
    ...
    argparser.add_argument("--load_save",
            type = str,
            default = "../trained_model/MetaQA_half",
            help = "load_save fold"
        )
